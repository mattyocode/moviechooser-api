    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_field",
                    models.CharField(db_column="type_", max_length=12, null=True),
                ),
                (
                    "actors",
                    models.ManyToManyField(
                        blank=True, related_name="movie", to="movies.Actor"
                    ),
                ),
                (
                    "director",
                    models.ManyToManyField(
                        blank=True, related_name="movie", to="movies.Director"
                    ),
                ),
                (
                    "genre",
                    models.ManyToManyField(
                        blank=True, related_name="movie", to="movies.Genre"
                    ),
                ),
            ],
        ),
